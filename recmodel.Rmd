...
Our final model with a weakly informative cauchy prior had a predictive accuracy of INSERT NUMBER on the training data. This accuracy is noticeably better than our null model that guesses 1 every time and ends up with an average prediction accuracy of a little over 50% because the data is comprised of a little over 50% liked songs. 
